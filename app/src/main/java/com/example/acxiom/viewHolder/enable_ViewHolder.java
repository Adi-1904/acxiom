...
public class enable_ViewHolder extends RecyclerView.ViewHolder {
    ...
    String user;
    public enable_ViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        disable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference doc=firestore.collection("disable").document(date.getText().toString());
                ...
                firestore.collection("enable").document(date.getText().toString()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
